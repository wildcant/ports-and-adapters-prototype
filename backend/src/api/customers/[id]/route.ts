import type { ICustomerModuleService, UpdateCustomerDTO } from '../../../core/types/index.js'
...
export const PATCH = async (req: HttpRequest<UpdateCustomerDTO>): Promise<HttpResult> => {
  const customerService = req.scope.resolve<ICustomerModuleService>(Modules.CUSTOMER)
